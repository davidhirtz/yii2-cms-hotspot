...
class SiteController extends \davidhirtz\yii2\cms\controllers\SiteController
{
    ...
    /**
     * Loads assets for entry and (if needed) related sections without file relations. Then checks if any assets contain
     ...
     * @return Asset[]
     */
    protected function findAssetsForEntry($entry)
    {
        $query = Asset::find()
